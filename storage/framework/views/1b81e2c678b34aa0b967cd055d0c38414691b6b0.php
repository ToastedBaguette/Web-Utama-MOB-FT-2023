        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3 secondary-font">Hai Maping, <?php echo e(Auth::user()->name); ?></span></h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Daftar Mahasiswa Kelompok <?php echo e(Auth::user()->beta); ?></h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin: Datatable-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Github Repository\Web-Utama-MOB-FT-2023\resources\views/maping/beta2.blade.php ENDPATH**/ ?>