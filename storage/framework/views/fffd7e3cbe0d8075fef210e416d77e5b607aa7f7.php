            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Daftar Mahasiswa Kelompok Delta <?php echo e(Auth::user()->alpha); ?></h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin: Datatable-->
