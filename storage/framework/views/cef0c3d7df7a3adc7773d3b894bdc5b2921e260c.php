            ...
            <div class="card card-custom card-stretch shadow-none">
                <div class="card card-custom shadow-none card-stretch">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($list!=null): ?>
                        <?php if($group == 'alpha'): ?>
                        <h3 style="margin: auto;width: 100%;padding: 10px;" class="gray">Presensi Delta <?php echo e($nomer); ?></h3>
                        <?php elseif($group == 'beta'): ?>
                        <h3 style="margin: auto;width: 100%;padding: 10px;" class="gray">Presensi Echo <?php echo e($nomer); ?></h3>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Catherine\Panitia\Web-Utama-MOB-FT-2023\resources\views/ad/index2.blade.php ENDPATH**/ ?>