                    ...
                    <div class="card card-custom gutter-b shadow-none">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <h2 class="d-flex align-items-center text-dark font-weight-bold">Hai,&nbsp<span class="text-primary"><?php echo e(Auth::user()->divisi); ?></span></h2>
                            </div>
