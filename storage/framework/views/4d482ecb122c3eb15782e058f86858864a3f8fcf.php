			...
			<nav class="navbar navbar-expand-lg classic transparent navbar-light">
				<div class="container flex-lg-row flex-nowrap align-items-center">
					<div class="navbar-brand w-100">
						<a class="main-font fs-24" href="<?php echo e(route('home')); ?>">MOB FT 2023</a>
					</div>
					<div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
						<div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
							<ul class="navbar-nav">
								<li class="nav-item">
									<a class="nav-link secondary-font" href="<?php echo e(route('welcome')); ?>">Beranda</a>
								</li>
								<li class="nav-item">
									<a class="nav-link secondary-font" href="<?php echo e(route('ormawa')); ?>">Ormawa</a>
								</li>
								<li class="nav-item">
									<a class="nav-link secondary-font" href="<?php echo e(route('profile')); ?>">Ubah Profil</a>
								</li>
								<li class="logout">
									<a href="<?php echo e(route('logout')); ?>"
										onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
										class="text-danger"><?php echo e(__('Logout')); ?></a>
						...
						<ul class="navbar-nav flex-row align-items-center ms-auto">
							<li class="nav-item d-none d-md-block">
								<a href="<?php echo e(route('logout')); ?>"
									...
									style="background-color:#e2626B; border-color: #e2626B"><?php echo e(__('Logout')); ?></a>
...
</html><?php /**PATH C:\Github Repository\Web-Utama-MOB-FT-2023\resources\views/layouts/maharu2023.blade.php ENDPATH**/ ?>