      ...
      <div class="container pt-10 pt-md-14 pb-md-16 text-center">
        <div class="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 mb-14 align-items-center">
          <div class="col-lg-7 order-lg-2" >
            <figure><img class="img-auto" src="<?php echo e(url('./assets/mob-assets/logo.png')); ?>" srcset="<?php echo e(url('./assets/mob-assets/logo.png')); ?> 2x" alt="" style="max-height: 70vh; max-width: 70vh;" /></figure>
            <?php if(!$login): ?>
    ...
    <section id="storyline" class="wrapper bg-gradient-primary">
      <div class="container pt-14 py-md-16">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-12 align-items-center">
          ...
          <div class="col-lg-6">
            <h3 class="display-5 mb-5 text-center">Storyline</h3>
            <div class="swiper-container dots-closer mb-6" data-margin="0" data-dots="true" data-items-md="1" data-items-xs="1">
              <div class="swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="item-inner">
                    <p class="mb-7">Di suatu Benua bernama Apollo terdapat suatu kerajaan yang bernama Kerajaan Xavier. Kerajaan Xavier merupakan kerajaan yang indah pada awal masa kejayaannya, namun karena kerajaan Xavier dipimpin oleh seorang raja yang sangat tamak dan haus kekuasaan, maka Kerajaan Xavier kondisinya semakin memprihatinkan. Seiring dengan berjalannya waktu, kondisi kerajaan Xavier mulai menurun hingga menuju ke masa kehancurannya. Caden, yang merupakan pangeran kerajaan Xavier sekaligus anak dari raja yang berkuasa di Kerajaan Xavier berinisiatif untuk memulihkan Xavier dengan mencari suatu berkat yang merupakan legenda mitos dari kerajaan tersebut.</p>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="item-inner">
                    <p class="mb-7">Legenda itu mengatakan bahwa ada suatu berkat bernama Solasta yang dapat memulihkan keadaan Xavier seperti pada masa kejayaannya. Konon katanya, jika Solasta berhasil ditemukan, maka keinginan terbesar dari penemunya akan terwujud. Namun untuk mendapatkan Solasta tersebut, Caden harus melewati berbagai tantangan yang ada di depannya.</p>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="item-inner">
                    <p class="mb-7">Dalam segala situasi, Caden selalu membawa hewan peliharaan kesayangannya yang ia beri nama Luxor. Saat Kerajaan Xavier masih indah seperti sedia kala, Luxor memiliki tugas untuk mengamati para warga. Bersama dengan Luxor yang merupakan elang kesayangan Caden, mereka berpetualang mencari Solasta. Warga kerajaan Xavier yang mendapatkan gelar Survivor memiliki tugas untuk ikut serta bersama Pangeran Caden dalam tujuan menyelamatkan rumah mereka yaitu Xavier seperti sedia kala. Selama perjalanan yang mereka lalui, mereka akan bertemu dengan para Observer yang akan berusaha untuk menguji apakah mereka tulus dan semangat untuk menjadikan Kerajaan Xavier menjadi baik seperti sedia kala.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <h2 class="display-4 mb-3 text-center">FAQ</h2>
              ...
              <div class="card  accordion-item">
                <div class="card-header" id="headingFour-2">
                  <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour-2" aria-expanded="false" aria-controls="collapseFour-2"> Apakah modul wajib diprint? </button>
                </div>
                <!--/.card-header -->
                <div id="collapseFour-2" class="accordion-collapse collapse" aria-labelledby="headingFour-2" data-bs-parent="#accordionExample-2">
                  <div class="card-body">
              ...
              <div class="card  accordion-item">
                <div class="card-header" id="headingFive-2">
                  <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFive-2" aria-expanded="false" aria-controls="collapseFive-2"> Bagaimana ketentuan print modul? </button>
                </div>
                <!--/.card-header -->
                <div id="collapseFive-2" class="accordion-collapse collapse" aria-labelledby="headingFive-2" data-bs-parent="#accordionExample-2">
                  <div class="card-body">
                    <p>Kertas berukuran A4, dijilid menggunakan lakban hitam  dan mika bening dengan urutan mika-modul-mika, boleh hitam putih atau berwarna, dan boleh bolak-balik.</p>
                  </div>
                  <!--/.card-body -->
                </div>
                <!--/.accordion-collapse -->
              ...
              <div class="card  accordion-item">
                <div class="card-header" id="headingNine-2">
                  <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseNine-2" aria-expanded="false" aria-controls="collapseNine-2"> Bagaimana cara untuk melihat absensi? </button>
                </div>
                <!--/.card-header -->
              ...
              <div class="card  accordion-item">
                <div class="card-header" id="headingTen-2">
                  <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTen-2" aria-expanded="false" aria-controls="collapseTen-2"> Apabila lupa password untuk login website, siapa yang harus saya hubungi? </button>
                </div>
                <!--/.card-header -->
                <div id="collapseTen-2" class="accordion-collapse collapse" aria-labelledby="headingTen-2" data-bs-parent="#accordionExample-2">
                  <div class="card-body">
...
<?php /**PATH C:\Github Repository\Web-Utama-MOB-FT-2023\resources\views/welcome2022.blade.php ENDPATH**/ ?>