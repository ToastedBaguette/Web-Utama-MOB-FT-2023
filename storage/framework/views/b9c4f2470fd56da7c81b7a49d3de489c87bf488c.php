                ...
                <h2 class="ms-2">Wah baru pertama kali login nih, silahkan masukkan password baru</h2>
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-4">
                        <input id="password" type="password" name="password" class="pass-check form-control <?php $__errorArgs = ['password'];
...
unset($__errorArgs, $__bag); ?>" required autocomplete="current-password">
                    ...
                    <div class="col-md-12">
                      <div class="form-floating mb-4">
                        <input id="password2" type="password" name="password2" class="pass-check form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- /column -->
                    <div class="col-12">
                      <input type="submit" id="gnti_pw" data-href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary rounded-5 btn-send" href="#" value="Konfirmasi" disabled>
                    </div>
                    <!-- /column -->
                  <!-- </div> -->
                  <!-- /.row -->
...
<?php /**PATH C:\Users\nicov\Documents\GitHub\Web-Utama-MOB-FT-2023\resources\views/resetpassword2022.blade.php ENDPATH**/ ?>