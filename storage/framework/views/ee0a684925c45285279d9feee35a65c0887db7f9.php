			...
			<div class="container text-center">
				<div class="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 align-items-center">
					...
					<div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start">
						<h2 class="display-5 mb-5 mx-md-10 mx-lg-0 text-center"><span class="typer text-dark secondary-font" data-loop="false" data-delay="100" data-words="Hi <?php echo e($nama); ?>"></span><span class="cursor text-dark" data-owner="typer"></span></h2>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="wrapper bg-light"">
			<div class="card shadow m-lg-5 p-lg-5 bg-footer">
				<div class="card-body">
					...
					<div class="row text-center">
						<div class="col-xl-10 mx-auto">
							<h3 class="display-4 mb-5 px-xxl-15 fs-25 text-white secondary-font">Sabar ya, belum ada absensi yang dibuka</h3>
						</div>
					</div>
					<?php else: ?>
		...
		<section class="wrapper bg-light">
			<div class="card shadow m-lg-5 p-lg-5 ">
				<div class="card-body">
					...
					<div class="row text-center">
						<div class="col-xl-10 mx-auto">
							<h3 class="display-4 mb-10 px-xxl-15 fs-25 secondary-font">Good Job, masih belum punya pelanggaran nih</h3>
						</div>
					</div>
					<?php else: ?>
