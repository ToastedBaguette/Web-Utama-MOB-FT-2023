                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body ml-3">
                                                    <form action="<?php echo e(route('ubahdata')); ?>" method="post"></form>
                                ...
                                <td><?php echo e($mhr->divisi); ?></td>
                                <td>
                                    <a href='#modalChange_<?php echo e($mhr->nrp); ?>' data-toggle='modal'>
                                        <button type="button" class="btn btn-success mt-2 mb-2">Ubah</button>
                                    </a>
                                    <a href="<?php echo e(url('resetpwdpanit/'.$mhr->nrp)); ?>">
...
<!--end::Page Scripts-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Catherine\Panitia\Web-Utama-MOB-FT-2023\resources\views/itd/listpanit.blade.php ENDPATH**/ ?>