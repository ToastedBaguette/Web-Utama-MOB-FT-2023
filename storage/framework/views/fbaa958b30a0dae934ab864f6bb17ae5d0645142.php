        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5 ml-3">
                    <!--begin::Page Title-->
                    <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Hai SFD, <?php echo e(Auth::user()->name); ?></h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                ...
                <div class="card card-custom bg-primary card-stretch gutter-b shadow-none">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-white mt-3 font-weight-normal font-size-sm">yang pelanggaran di hari ini</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
            ...
            <div class="">
                ...
                <div class="">
                    ...
                    <div class="alert alert-custom alert-light-success fade show mb-5" role="alert" style="width:100%; Max-height:5em;">
                        ...
                        <div class="alert-text" style="font-size:125%;"><label for=""><?php echo e(session('status')); ?></label></div>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_3_2" role="tabpanel">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable3" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align:center;"><a href="#showRekap" onclick="getRekap(<?php echo e($h->nrp); ?>)" data-toggle='modal' class="text-success"><button type="button" class="btn btn-success" style="min-width:100px"><?php echo e($h->nrp); ?></button></a></td>
                                            <td><?php echo e($h->name); ?></td>
                                            <td style="text-align:center;"><?php echo e($h->alpha); ?></td>
                                            <td style="text-align:center;"><?php echo e($h->beta); ?></td>
                                            <td style="text-align:center;"><?php echo e($h->jenis_pelanggaran); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Catherine\Panitia\Web-Utama-MOB-FT-2023\resources\views/sfd/rekap2.blade.php ENDPATH**/ ?>