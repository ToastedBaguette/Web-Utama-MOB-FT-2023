...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <!--begin::Page Title-->
    <!-- <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Hai,&nbsp<span class="text-primary"><?php echo e(Auth::user()->divisi); ?></span></h2> -->
                    ...
                    <div class="card card-custom gutter-b shadow-none">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <h2 class="d-flex align-items-center text-dark font-weight-bold">Halo,&nbsp<span class="text-primary"><?php echo e(Auth::user()->divisi); ?></span></h2>
                            </div>
                            <div class="d-flex align-items-center mb-6">
                                <h1 class="font-weight-bolder text-primary display-3"><?php echo e(Auth::user()->name); ?></h1>
                            </div>
                            <div>
                                <h5 class="text-dark font-weight-normal pb-2"><small class="text-muted">NRP&nbsp</small><?php echo e(Auth::user()->nrp); ?></h5>
                                <h5 class="text-dark font-weight-normal pb-2"><small class="text-muted">Email&nbsp</small><?php echo e(Auth::user()->email); ?></h5>
                                <?php if(Auth::user()->divisi =='MAPING'): ?>
                                <h5 class="text-dark font-weight-normal pb-2"><small class="text-muted">Kelompok&nbsp</small>Delta <?php echo e(Auth::user()->alpha); ?></h5>
                                <h5 class="text-dark font-weight-normal pb-2"><small class="text-muted">Kelompok&nbsp</small>Echo <?php echo e(Auth::user()->beta); ?></h5>
                                <?php endif; ?>
                            </div>
                            <!--end::User-->
                        </div>
