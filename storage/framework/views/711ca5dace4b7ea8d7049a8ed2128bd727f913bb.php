                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <h2 class="d-flex align-items-center text-dark font-weight-bold secondary-font">
                                    Hai,&nbsp<span class="text-primary secondary-font"><?php echo e(Auth::user()->divisi); ?></span>
                                </h2>
                            </div>
...
<?php $__env->stopSection(); ?>
<!--end::Content-->
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UNIVERSITAS\UBAYA\Panitia\MOB FT 2023\WEB 2023\Web-Utama-MOB-FT-2023\resources\views/dashboardpanitia2023.blade.php ENDPATH**/ ?>