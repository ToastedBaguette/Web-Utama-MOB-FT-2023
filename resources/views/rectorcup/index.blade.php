...
@section('header')
<header id="navbar" class="main-header main-header-overlay" style='position: fixed; background-color:transparant;'>
...
<main class="content bg-cover" style="background-image: url('./img/bg5.png');">
		...
		<div class="container">
			<div class="row">
				...
				<header class="fancy-header text-center">
					<h2 class="font-size-40" style="color: #4fda91; text-shadow: 2px 0px 20px #70E8C6">Daftar Cabang<br>Rector Cup 2021</h2>
				</header>
				...
				<div class="lqd-column col-md-12 transparent-card" id="tableRCdanProfile">
					...
					<div class="fancy-box fancy-box-offer fancy-box-offer-header text-center">
						...
						<div class="fancy-box-cell fancy-box-header">
							<h4 class="text-white">Riwayat Daftar</h4>
						</div><!-- /.fancy-box-header -->

						<div class="fancy-box-cell">
							<p class="text-white">Tanggal dan<br>Jam Seleksi</p>
						</div><!-- /.fancy-box-cell -->
						...
						<div class="fancy-box-cell">
							<p class="text-white">Nama<br>Koorcab</p>
						</div><!-- /.fancy-box-cell -->

						<div class="fancy-box-cell">
							<p class="text-white">Kontak<br>(LINE)</p>
						</div><!-- /.fancy-box-cell -->
					...
					@if(count($riwayatdftr) < 1)
						<div class="iconbox text-center iconbox-xl iconbox-icon-image px-5 pt-40 mx-md-2">
							...
							<div class="contents">
							<p><span style="font-size: 20px;line-height: 30px">Kamu belum daftar Rector Cup, <a href="#daftarRc" class="text-white font-weight-bold text-underline">buruan daftar!</a> Maksimal 2 cabang ya</span></p>
							<br></div><!-- /.contants -->
						</div><!-- /.iconbox -->
						@else
						...
						<div class="fancy-box fancy-box-offer fancy-box-heading-sm text-center">
							...
							<div class="fancy-box-cell fancy-box-header">
								...
								<figure class="fancy-box-image">
									<img src="./img/icon/{{$h->nama_cabang}}.svg" alt="{{$h->nama_cabang}}" style="width:50%; height: 50%">
								</figure>
								<h3  class="text-white">
									{{$h->nama_cabang}}
								</h3>
							...
							<div class="fancy-box-cell" data-text="Tanggal dan Jam Seleksi">
								<h5 class="text-white">
									<?php echo date('d M Y',strtotime($h->tanggal_seleksi));?>
									<small style="color: lightgray">{{$h->jam_seleksi}} WIB</small>
								</h5>
							</div><!-- /.fancy-box-cell -->
	...
	<section id="daftarRc" class="vc_row pt-50 pb-50">
		<div class="container">
			<div class="row">
				...
				<div class="lqd-column col-md-12 transparent-card" id="tableRCdanProfile">
					...
					<div class="fancy-box fancy-box-offer fancy-box-offer-header text-center">
						...
						<div class="fancy-box-cell fancy-box-header text-left">
							<h4 class="text-white">Daftar<br>Cabang RC</h4>
						</div><!-- /.fancy-box-header -->

						<div class="fancy-box-cell">
							<p class="text-white">Status<br>Daftar</p>
						</div><!-- /.fancy-box-cell -->

						<div class="fancy-box-cell">
							<p class="text-white">Kuota</p>
						</div><!-- /.fancy-box-cell -->
					...
					@foreach($listrc as $h)
						<div class="fancy-box fancy-box-offer fancy-box-heading-sm text-center">
							...
							<div class="fancy-box-cell fancy-box-header">
								...
								<figure class="fancy-box-image" style="width:40%;">
									<img src="./img/icon/{{$h->nama_cabang}}.svg" alt="{{$h->nama_cabang}}" style="width:90%; height: 90%">
								</figure>
								<h3 id="textCabang" class="text-white" style="width:50%;">
									{{$h->nama_cabang}}
								</h3>
							...
							<div class="fancy-box-cell" data-text="Syarat">
								<a href="#modalSyarat" class="btn btn-sm btn-bordered font-weight-bold lh-15" onclick="getsyarat({{$h->idrc}})"  style="border-radius: 2rem" data-lity="#modalSyarat">
									<span>
							...
							@if($jumlahambil[0]->jumlahambil < 2)
								...
								@if($h->status=="Buka")
									...
									<?php
										if($sudah==true){
										echo("<h5 class='text-white'>Sudah daftar</h5>");
										}
										else{?>
										@if (Auth::user()->status == 'maharu')
										<a href="#modalDaftar" class="btn btn-sm btn-solid font-weight-semibold lh-15" onclick="getDaftar({{$h->idrc}}, {{$usernrp}})" style="border-radius: 2rem" data-lity="#modalDaftar">
										...
										?>
									@else
										<h5 class="text-white">Waktu Daftar RC telah selesai</h5>
									@endif
								@else
								<h5 class="text-white">Pendaftaran Ditutup</h5>
								@endif
								</div><!-- /.fancy-box fancy-box-booking -->
							@endif
							</div><!-- /.fancy-box-cell -->
	...
	<!-- Modal Syarat -->
		<div id="modalSyarat" class="lqd-modal lity-hide col-md-12 justify-content-center">
			<div class="lqd-modal-inner" id="isiModalSyarat">
	...
	<div id="modalDaftar" class="lqd-modal lity-hide col-md-12 justify-content-center">
			<div class="lqd-modal-inner" id="isiModalDaftar">
				<div class="iconbox-icon-wrap text-center">
					<span class="iconbox-icon-container mb-45">
					    <img src="./img/loading.gif"/>
					</span>
