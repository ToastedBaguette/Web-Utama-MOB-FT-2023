          ...
          <div class="navbar-other ms-lg-4">
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              <li class="nav-item d-none d-md-block">
                @if(!$login)
                <a href="{{route('login')}}" class="btn btn-sm btn-primary rounded secondary-font text-white pt-2">Login</a>
                @else
      ...
      <div class="container pt-10 pt-md-14 pb-md-12 text-center">
        <div class="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 mb-14 align-items-center">
          <div class="col-lg-7 order-lg-2">
            ...
            @if(!$login)
            <a href="{{route('login')}}" class="mt-8 btn btn-lg btn-primary rounded-pill d-lg-none">Login</a>
            @else
          ...
          <div class="accordion accordion-wrapper" id="accordionExample-2">
            ...
            <div class="card  accordion-item">
              ...
              <div id="collapseFive-2" class="accordion-collapse collapse" aria-labelledby="headingFive-2"
                data-bs-parent="#accordionExample-2">
                <div class="card-body">
                  <p>Kertas berukuran A4, dijilid menggunakan lakban hitam dan mika bening dengan urutan mika-modul-mika, 
                    boleh hitam putih atau berwarna, dan boleh bolak-balik (kecuali pada halaman tertentu, 
                    tidak boleh bolak-balik)</p>
                </div>
                <!--/.card-body -->
              </div>
              <!--/.accordion-collapse -->
