...
@endsection
@section('content')
<section id="content" class="vc_row fullheight d-flex flex-wrap align-items-center bg-cover"
    style="background-image: url('./img/login.png'); background-color:#33334D;">
    <div class="container">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row loginBox">
                                <label for="nrp" class="col-md-4 col-form-label text-md-left text-white">{{ __('NRP')
                                    }}</label>

                                <div class="col-md-6">
                                    <input id="nrp" type="text"
                                        class="form-control text-white underline-form @error('nrp') is-invalid @enderror"
                                        name="nrp" value="{{ old('nrp') }}" required autofocus
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-left text-white">Kata
                                    Sandi</label>
                                <div class="col-md-6">
                                    ...
                                    <div class="invalid-feedback mt-3">
                                        <p
                                            ...
                                            Ada yang salah nih, coba lagi</p>
                                    </div>
                                    @endif
                                </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button type="submit"
                                        class="btn btn-sm circle btn-solid font-size-14 ltr-sp-025 px-2 lh-15 mt-5 buttonLogin font-weight-semibold">
                                        <span class="btn-gradient-bg"></span>
