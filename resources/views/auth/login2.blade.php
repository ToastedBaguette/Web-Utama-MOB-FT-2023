                        ...
                        <div class="lqd-column col-md-10 col-md-offset-1">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group row loginBox">
                                    <label for="nrp" class="col-md-4 col-form-label text-md-left text-white">{{
                                        __('NRP') }}</label>
                                    <div class="col-md-6">
                                        <input id="nrp" type="text"
                                            class="form-control @error('nrp') is-invalid @enderror" name="nrp"
                                            value="{{ old('nrp') }}" required autofocus>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-form-label text-md-left text-white">{{
                                        __('Password') }}</label>
