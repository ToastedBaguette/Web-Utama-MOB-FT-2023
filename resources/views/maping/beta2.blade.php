            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3 ">Hai Maping,
            ...
            <div class="container">
                ...
                <div class="">
                    @if (session('status'))
                        <div class="alert alert-custom alert-light-success fade show mb-5" role="alert"
                            ...
                            <div class="alert-text" style="font-size:120%;"><label
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Daftar Mahasiswa Kelompok Teta {{ Auth::user()->beta }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
                                        ...
                                        <td>
                                            <a href='#modalChange_{{ $mhr->nrp }}' data-toggle='modal'>
                                                <button type="button" class="btn btn-success"
                                                    style="min-width:100px; background-color: #40128B">{{ $mhr->nrp }}</button>
                                            </a>
                                            <div class="modal fade" id="modalChange_{{ $mhr->nrp }}" tabindex="-1"
                                                role="basic" aria-hidden="true" style="text-align:LEFT;">
                ...
                @if ($presensi != 'saat ini belum ada presensi yang sedang dibuka')
                    <div class="card card-custom" style="margin-top:50px;">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Input Presensi Teta</h3>
                        ...
                        <div class="card-body">
                            <form action="{{ route('presensimaping') }}" method="post">
                                ...
                                <select class="form-control" name="waktu_presensi" id="jam" style="width:100%;"
                                    required>
                                    ...
                                    @foreach ($beta as $mhr)
                                        <label class="checkbox">
                                            <input type="checkbox" name='mahasiswa[]'
                                                value="{{ $mhr->nrp }}"><span></span>{{ $mhr->name }}
                                        </label>
                                    @endforeach
                                </div>
