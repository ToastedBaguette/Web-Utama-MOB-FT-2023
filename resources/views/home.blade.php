...
<main class="content bg-cover" style="background-image: url('./img/bg5.png');">
    <!-- Hi Maharu -->
    <section id="content" class="vc_row py-5 mb-60 fullheight d-flex flex-wrap align-items-center" style="background-color: transparent;">
        <div class="container">
            <div class="row">
                ...
                <div class="lqd-column col-lg-7 col-md-8" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","delay":"150","easing":"easeOutQuint","direction":"forward","initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
                    ...
                    <a href="#modalPresensi" class="btn btn-sm circle btn-solid font-size-14 ltr-sp-025 px-2 lh-15 mt-5 font-weight-semibold" data-lity="#modalPresensi">
                        <span>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" class="btn-gradient-border" width="100%" height="100%">
                                ...
                                <rect x="0.5" y="0.5" rx="24" ry="24" width="100%" height="100%" stroke="url(#svg-border-5c77b6395a8f2)"></rect>
                            </svg>
                        </span>
                    </a>
    ...
    <section id="pengumuman" class="vc_row pt-100 pb-50 bg-cover" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "initValues":{"translateY": 100, "opacity":0}, "animations":{"translateY": 0, "opacity":1}}'>
        <div class="container">
    ...
    <section id="acara" class="vc_row pt-100 pb-110" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "initValues":{"translateY": 100, "opacity":0}, "animations":{"translateY": 0, "opacity":1}}'>
        <div class="container">
            <div class="row">
                <div class="lqd-column col-md-6 col-md-offset-3">

                    <header class="fancy-heading text-center mb-4">
                        <h2 class="font-size-40 my-0" style="color: #4fda91; text-shadow: 2px 0px 20px #70E8C6">Kegiatan Saat Ini</h2>
                    </header>
                    <br>
            ...
            <div class="row">
                ...
                <div class="lqd-column col-md-6 col-md-offset-3 px-md-5 mb-60">
                    <header class="fancy-heading text-center">
                        <h2 class="mt-0 font-size-44" style="color: #4fda91; text-shadow: 2px 0px 20px #70E8C6">Jadwal MOB FT 2021</h2>
                        <p class="font-size-17 lh-175 text-glow2">
                            @if ((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('July 30 2021')))

                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('July 31 2021')))
                            MOB FT 2021 Hari Pertama
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 01 2021')))
                            MOB FT 2021 Hari Kedua
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 03 2021')))
                            MOB FT 2021 Hari Ketiga
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 04 2021')))
                            MOB FT 2021 Hari Keempat
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 05 2021')))
                            Rector Cup Hari Pertama
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 06 2021')))
                            Rector Cup Hari Kedua
                            @elseif((\Carbon\Carbon::now()) < (\Carbon\Carbon::parse('August 07 2021')))
                            Rector Cup Hari Ketiga dan Hari Apreasi Seni
                            @endif
                        </p>
                        ...
                        <div class="one-roadmap-inner">
                            ...
                            ?>
                                ...
                                <div class="one-roadmap-info">
                                    <h6><?php echo date('d M Y',strtotime($j->tanggal))."<br>".date('H:i',strtotime($j->waktu_awal))." - ".date('H:i',strtotime($j->waktu_akhir)); ?> WIB</h6>
                                    <p>{{$j-> kegiatan}}</p>
                 ...
                 <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <div class="row">
                            <div class="lqd-column col-md-8 col-md-offset-2">
                                @if($status == 'belum')
                                <p style="color: darkgray" id="presensi_text">Apakah kamu yakin melakukan presensi pada Jam <?php echo date('H:i',strtotime($p_awal)); ?> WIB hingga <?php echo date('H:i',strtotime($p_akhir)); ?> WIB?</p>
                                @endif
                ...
                <div class="col-md-12 text-center">
                    ...
                    @else
                        ...
                        <div id="sudah_presensi">
                            <a href="#modalInfoPresensi" id="presensi-sekarang" class="btn btn-solid btn-bordered border-thin circle font-size-12 lh-15 font-weight-bold ltr-sp-05 mb-2" data-lity="#modalInfoPresensi">
