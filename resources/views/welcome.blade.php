                    ...
                    <div class="col">
                        ...
                        <ul id="primary-nav" class="main-nav nav align-items-lg-stretch justify-content-lg-end main-nav-hover-underline-1" data-submenu-options='{ "toggleType":"fade", "handler":"mouse-in-out" }' data-localscroll="true">
							...
							@guest
								<li >
									<div id="divLogin">
									<a id="aLogin" class="btn btn-solid text-uppercase circle btn-bordered border-thick font-size-12 font-weight-semibold" href="{{route('login')}}">
									<span>
...
<main class="content bg-cover" style="background-image: url('./img/bg5.png');">
	...
	<section id="content" class="vc_row py-5 fullheight d-flex flex-wrap align-items-center" style="background-color: transparent;">
		<div class="container">
			<div class="row">

				<div class="lqd-column col-lg-6 col-md-6 col-6" style="margin-left:0;" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","delay":"150","easing":"easeOutQuint","direction":"forward","initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>

					<div class="ld-fancy-heading">
						<h2 class="h1 text-white mt-20" data-fittext="true" data-fittext-options='{"compressor":0.5,"maxFontSize":"currentFontSize","minFontSize":"35"}' data-split-text="true" data-split-options='{"type":"lines"}'>
							<span id="titleHome" class="ld-fh-txt text-glow2"> Selamat Datang di <br> <br> MOB FT 2022</span>
						</h2>
						<div class="lqd-column col-md-11 col-xs-12">
							...
							<div class="lqd-column-inner">
								...
								<a target="_blank" href="https://tinyurl.com/ModulMOBFT2021" id="downloadButton" class="btn btn-outline btn-sm circle btn-bordered font-size-14 ltr-sp-025 px-2 lh-15 font-weight-semibold">
									<span>
										<span class="btn-txt">Unduh Modul</span>
									</span>
								</a>

								<a href="https://docs.google.com/spreadsheets/d/1tIwmGb42Bvs2QpwJ935UoiMC4wXKMwg9CnjgULeAtkw/edit#gid=0" target="_blank" class="btn btn-outline btn-sm circle btn-bordered font-size-14 ltr-sp-025 px-2 lh-15 font-weight-semibold">
									<span>
				...
				<div id="jam" style=" margin-top:4vh;max-width:100%;max-height:100%;" class="lqd-column col-lg-6 col-md-6 col-6" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","delay":"150","easing":"easeOutQuint","direction":"forward","initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
		...
		<div class="row d-flex flex-wrap align-items-center">
							...
							<div class="liquid-img-group-single">
								<div class="liquid-img-group-img-container">
									<div class="liquid-img-container-inner">
										<figure>
											<img id="gambarTerbang" src="./img/terbang.png" class="terbang" alt="Setup Ave" />
										</figure>
				...
				<div class="lqd-column col-md-6 pl-md-6 pr-md-7" style="margin:0;">
					...
					<header class="fancy-header text-center mb-35">
						...
						<p  id="tulisan" class="text-justify text-glow2">Ferdy dan Nayla adalah sepasang ilmuwan yang berhasil menciptakan mesin waktu.
							Dengan pimpinan mereka, Roamerus kembali ke masa lalu untuk mempelajari kehidupan-kehidupan di masa lampau.
							Ketika melewati masa-masa dalam sejarah, tiba-tiba mesin waktu mulai tidak bisa dikontrol dan akhirnya mereka terpaksa
							untuk berhenti pada suatu masa yang tidak diketahui. Saat menyadarinya, ternyata mereka terdampar di tepi kota bernama Horizon.
							Di kota yang sangat maju itulah Ferdy dan Nayla memulai perjalanan mereka dan menemukan hal - hal baru yang telah melampaui masa sekarang.
							Apa saja yang dilakukan Ferdy dan Nayla di Kota Horizon?
							Akankah Ferdy dan Nayla berhasil memperbaiki mesin waktu mereka? Ikuti perjalanan Ferdy dan Nayla di Kota Horizon
	...
	<section id="jadwal" class="vc_row pt-90 pb-90 mt-100 mb-100 bg-cover" data-parallax="true" data-parallax-options='{"parallaxBG":true}'>
		<div class="container">
			<div class="row">
				...
				<div class="lqd-column col-md-10 col-md-offset-1 mb-70">
					...
					<div class="one-roadmap" data-custom-animations="true" data-ca-options='{"triggerHandler": "inview", "animationTarget": ".one-roadmap-item", "duration": 1200, "delay": 150, "easing": "easeOutQuint", "initValues": { "translateY": 50, "translateZ": -150, "rotateX": -95, "opacity": 0 }, "animations": { "translateY": 0, "translateZ": 0, "rotateX": 0, "opacity": 1 }}'>
		...
		<section id="rectorcup" class="vc_row pt-150 pb-70 mt-100 " >
			...
			<div class="container">
				<div class="row mb-150">
					...
					<div class="lqd-column col-md-10 col-md-offset-1">
						<div id="showMedal" style="display:none;">
							...
							<div>
								<h2 class="text-glow4" id="text-glow4" style="position: absolute; top: 50%; left: 25%; transform: translate(-50%, 50%); ">{{$perak[0]->Jumlah}}</h2>
								<h2 class="text-glow4" id="text-glow4" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, 50%);">{{$emas[0]->Jumlah}}</h2>
								<h2 class="text-glow4" id="text-glow4" style="position: absolute; top: 50%; left: 75%; transform: translate(-50%, 50%);">{{$perunggu[0]->Jumlah}}</h2>
							</div>
						</div>
					</div>
						...
						<div  class="carousel-container carousel-vertical-3d">
							...
							<div class="carousel-items">
								...
								<div class="carousel-item">
									...
									<div class="iconbox iconbox-side iconbox-round iconbox-shadow iconbox-heading-sm iconbox-filled iconbox-filled iconbox-filled-hover" id="iconbox-carousel-3" data-animate-icon="true" data-plugin-options='{"color":"rgb(131, 11, 176):rgb(186, 0, 255)","hoverColor":"#fff"}'>
										<span class="iconbox-fill-el iconbox-fill-el-hover bg-gradient-secondary-br"></span>
										<div class="iconbox-icon-wrap">
											<span class="iconbox-icon-container">
										...
										<div class="contents titleRC">
											...
											<p style="color: darkgray">Paduan Suara, Cover Dance, Band, Solo Singer, Short Comic, Desain Poster, Cipta Lagu, Stand Up Comedy, MC Formal, Face Painting, dan Fotografi.</p>
										</div><!-- /.contents -->
									</div><!-- /.iconbox -->
				...
				<div class="row" id="tabelRC" style="display:none;" data-custom-animations="true" data-ca-options='{"triggerHandler": "inview", "animationTarget": ".fancy-box-cell", "duration": 1200, "delay": 150, "easing": "easeOutQuint", "initValues": { "translateY": 50, "translateZ": -150, "rotateX": -95, "opacity": 0 }, "animations": { "translateY": 0, "translateZ": 0, "rotateX": 0, "opacity": 1 }}'>
							...
							<div class="fancy-box fancy-box-offer fancy-box-heading-sm" id="tabelCabor">
								...
								<div class="fancy-box-cell fancy-box-header" id="caborDesktop">
									...
									<figure class="fancy-box-image ">
										<div>
											<img src=".\img\icon\{{$m->nama_cabang}}.svg" class="glow"  alt="Icon Cabang" style="width: 60%; height: 60%">
										</div>
									</figure>
	...
	<!-- FAQ -->
	<section id="faq" class="vc_row pt-70 pb-50" data-custom-animations="true" data-ca-options='{"triggerHandler": "inview", "animationTarget": ".fancy-box-cell", "duration": 1200, "delay": 150, "easing": "easeOutQuint", "initValues": { "translateY": 50, "translateZ": -150, "rotateX": -95, "opacity": 0 }, "animations": { "translateY": 0, "translateZ": 0, "rotateX": 0, "opacity": 1 }}'>
		<div class="container">
			<div class="row">
				...
				<div id="faqBox"class="lqd-column col-md-8 col-md-offset-2">
					...
					<div class="lqd-column-inner transparent-card px-2 px-md-6 pt-55 pb-40 faqInner" style="border-radius: 1rem;">

						<div class="accordion accordion-tall accordion-body-underlined accordion-expander-lg" id="crypto-accordion-1" role="tablist">

							<div class="accordion-item panel  active">
								<div class="accordion-heading textFaq" role="tab" id="crypto-accordion-heading-1">
									<h4 class="accordion-title font-size-19">
										<a class="text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-panel-1" aria-expanded="true" aria-controls="crypto-accordion-panel-1">
											...
											<span class="accordion-expander">
												...
												<i>
													<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-dash-lg" viewBox="0 0 16 16">
								...
								<div id="crypto-accordion-panel-1" class="accordion-collapse collapse in textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-1">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Jadwal MOB bisa kalian lihat pada bagian "Jadwal" di Website MOB FT</p>
							...
							<div class="accordion-item panel">
								<div class="accordion-heading textFaq" role="tab" id="crypto-accordion-heading-2">
									<h4 class="accordion-title font-size-19 ">
										<a class="collapsed text-white " data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-2" aria-expanded="false" aria-controls="crypto-accordion-collapse-2">
								...
								<div id="crypto-accordion-collapse-2" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-2">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian bisa mempersiapkan perangkat elektronik (disarankan laptop/komputer), wifi/kuota internet, modul wajib print, dan alat tulis.
							...
							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-3">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-3" aria-expanded="false" aria-controls="crypto-accordion-collapse-3">
								...
								<div id="crypto-accordion-collapse-3" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-3">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Sayangnya iya teman-teman, karena kondisi saat ini belum memungkinkan dan PPKM Jawa-Bali diperpanjang.
										Jangan lupa juga tetap menggunakan prokes, jaga kesahatan, dan #stayathome!</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-4">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-4" aria-expanded="false" aria-controls="crypto-accordion-collapse-4">
								...
								<div id="crypto-accordion-collapse-4" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-4">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Pastinya dong, semua mahasiswa baru wajib berkontribusi dalam rector cup</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-5">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-5" aria-expanded="false" aria-controls="crypto-accordion-collapse-5">
								...
								<div id="crypto-accordion-collapse-5" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-5">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian bisa daftar Rector cup ketika Pra-MOB FT yang nantinya akan dipandu oleh Maping kelompok Beta, pendaftarannya sendiri akan dilakukan melalui website MOB FT 2021. Yuk daftar dan berpartisipasi di Rector Cup untuk membuat Teknik bangga!</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-6">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-6" aria-expanded="false" aria-controls="crypto-accordion-collapse-6">
								...
								<div id="crypto-accordion-collapse-6" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-6">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian bisa menekan tombol "Lihat Kelompok" di "Beranda" untuk melihat kalian ada di kelompok berapa</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-7">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-7" aria-expanded="false" aria-controls="crypto-accordion-collapse-7">
								...
								<div id="crypto-accordion-collapse-7" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-7">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Untuk link group besar MOB FT bisa kalian cek di linktree yang di share pada Instagram MOB FT 2021 (@mobft2021)
										dan untuk group tiap kelompok Alpha dan Beta akan diberitahukan melalui group besar MOB FT </p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-8">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-8" aria-expanded="false" aria-controls="crypto-accordion-collapse-8">
								...
								<div id="crypto-accordion-collapse-8" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-8">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Wajib dong dan semua halaman harus diprint ya</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-9">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-9" aria-expanded="false" aria-controls="crypto-accordion-collapse-9">
								...
								<div id="crypto-accordion-collapse-9" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-9">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Untuk print modul kalian diberi kebebasan untuk memilih apakah mau berwarna atau hitam putih, yang penting modul diprint</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-10">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-10" aria-expanded="false" aria-controls="crypto-accordion-collapse-10">
								...
								<div id="crypto-accordion-collapse-10" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-10">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Modul minimal diprint menggunakan ukuran kertas A4 ya</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-11">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-11" aria-expanded="false" aria-controls="crypto-accordion-collapse-11">
								...
								<div id="crypto-accordion-collapse-11" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-11">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian diberikan kebebasan untuk memilih mau diprint bolak balik atau tidak</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-12">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-12" aria-expanded="false" aria-controls="crypto-accordion-collapse-12">
											Apabila terjadi kendala saat MOB FT berlangsung, siapa yang harus saya hubungi?
											<span class="accordion-expander">
												<i>
													<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-plus-lg" viewBox="0 0 16 16">
														<path d="M8 0a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2H9v6a1 1 0 1 1-2 0V9H1a1 1 0 0 1 0-2h6V1a1 1 0 0 1 1-1z"/>
								...
								<div id="crypto-accordion-collapse-12" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-12">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian bisa menghubungi Maping dengan menggunakan format nama sesuai yang tertera di modul</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-13">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-13" aria-expanded="false" aria-controls="crypto-accordion-collapse-13">
											Apakah ada spesifikasi khusus mengenai peralatan yang perlu disiapkan (spesifikasi laptop, spesifikasi smartphone, dsb)?
											<span class="accordion-expander">
												<i>
													<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-plus-lg" viewBox="0 0 16 16">
														<path d="M8 0a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2H9v6a1 1 0 1 1-2 0V9H1a1 1 0 0 1 0-2h6V1a1 1 0 0 1 1-1z"/>
								...
								<div id="crypto-accordion-collapse-13" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-13">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">
										Perangkat yang digunakan harus memiliki kamera atau webcam karena semua peserta MOB FT 2021
										<b>WAJIB</b> menyalakan kamera selama acara MOB FT berlangsung. Jadi pastikan diperangkat yang digunakan terdapat kamera atau webcam ya</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-14">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-14" aria-expanded="false" aria-controls="crypto-accordion-collapse-14">
								...
								<div id="crypto-accordion-collapse-14" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-14">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kriteria kelulusan bisa dilihat di Modul MOB FT 2021 pada bagian Poin Kelulusan</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-15">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-15" aria-expanded="false" aria-controls="crypto-accordion-collapse-15">
								...
								<div id="crypto-accordion-collapse-15" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-15">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Peserta harus mengulang MOB FT pada tahun berikutnya. Jadi ikuti proses MOB dengan sungguh-sungguh ya teman-teman, agar tidak mengulang tahun depan </p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->

							<div class="accordion-item panel">
								<div class="accordion-heading text-white textFaq" role="tab" id="crypto-accordion-heading-16">
									<h4 class="accordion-title font-size-19">
										<a class="collapsed text-white" data-toggle="collapse" data-parent="#crypto-accordion-1" href="#crypto-accordion-collapse-16" aria-expanded="false" aria-controls="crypto-accordion-collapse-16">
								...
								<div id="crypto-accordion-collapse-16" class="accordion-collapse collapse textFaq2" role="tabpanel" aria-labelledby="crypto-accordion-heading-16">
									<div class="accordion-content">
										<p style="color: lightgray" class="text-justify">Kalian bisa menghubungi Maping yang bersangkutan pada sesi tersebut, jangan lupa menggunakan format nama sesuai yang tertera di modul</p>
									</div><!-- /.accordion-content -->
								</div><!-- /.collapse -->
							</div><!-- /.accordion-item -->
			...
			<div class="row">
				...
				<div  class="lqd-column col-md-12">
					...
					<div class="liquid-portfolio-list">
						<div style="width:70%; margin:auto;" class="row liquid-portfolio-list-row" data-liquid-masonry="true">
							...
							<div style="margin-top:1vh; width:230px" class="col-md-4 col-sm-6 col-xs-12 masonry-item teknik">
								<article class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid pf-hover-masktext">
									<div class="ld-pf-inner">
										<div class="ld-pf-image">
											<figure data-responsive-bg="true">
