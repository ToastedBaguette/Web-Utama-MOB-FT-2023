            ...
            <div class="card card-custom card-stretch shadow-none">
                <div class="card card-custom shadow-none card-stretch">
                    ...
                    <div class="card-body">
                        ...
                        @if($list!=null)
                        @if ($group == 'alpha')
                        <h3 style="margin: auto;width: 100%;padding: 10px;" class="gray">Presensi Delta {{$nomer}}</h3>
                        @elseif ($group == 'beta')
                        <h3 style="margin: auto;width: 100%;padding: 10px;" class="gray">Presensi Echo {{$nomer}}</h3>
