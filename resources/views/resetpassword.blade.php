					...
					<div class="row">
						...
						<div class="lqd-column col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror text-white font-size-24" name="password" required autocomplete="current-password">
