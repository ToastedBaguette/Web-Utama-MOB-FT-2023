	...
	<section class="vc_row pt-100 pb-60 mt-30">
        <div class="container">
            <header class="fancy-title text-center">
                <h2 class="my-0 text-glow">Sharing Petuah</h2>
            </header><!-- /.fancy-title -->
            ...
            @endif
                <div class="lqd-column col-md-4 col-md-offset-4">
                    ...
                    @foreach($petuah as $d)
                    <header class="fancy-title text-center">
                        <h5 class="my-0 font-size-24 text-white ">Petuahmu adalah</h5>
                        <br>
            ...
            <div class="row lqd-column col-md-12 px-4 pt-45 pb-30" style="border-radius: 1rem;" id="tableRCdanProfile">
                ...
                <div class="lqd-column col-md-12 text-center" style="margin-top:50px;">
                    ...
                    <header class="fancy-title">
                        ...
                        <div>
                        Kode yang tertera merupakan 5 huruf setelah huruf asli
                        <!-- Jika huruf yang tertera pada kode petuah adalah huruf "F", maka huruf aslinya adalah 5 huruf sebelum " F", yaitu "A"  -->
                        </div>
                        <div>
                        Contoh : 
                        "MFQT" berarti "HALO" 
                ...
                <header class="fancy-title">
                    <h3 class="text-glow">Daftar Petuah</h3>
                                    ...
                                    <div class="liquid-img-group-container">
                                        <div class="liquid-img-group-inner">
                                            <div class="liquid-img-group-single" data-reveal="true" data-reveal-options='{ "direction":"tb" }'>
                                                <figure>
                                                    <img src="{{asset('img/petuah/'.$d->idpetuah.'.png')}}" alt="{{$d->nama_petuah}}" style="border-radius: 1rem" id="fotoPetuah"/>
                                                </figure>
